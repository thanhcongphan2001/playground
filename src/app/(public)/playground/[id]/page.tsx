...
export default function ApiExplorerPage({ params }: PageProps) {
	...
	return (
		<div className="flex h-full flex-col  bg-gray-50 ">
			{/* Fixed Header */}
			<header className="sticky top-0 z-50 flex items-center justify-between border-b border-gray-200 bg-white px-4 py-3 sm:px-6 lg:px-[120px]">
				<div className="flex items-center gap-3">
					...
					<div className="flex items-center gap-2">
						<span className="text-base sm:text-lg text-[#101828] leading-[1.364] truncate">
							GtelMap {config.label} Playground
						</span>
					</div>
				</div>
			</header>
			...
			<div className="flex flex-1 flex-col  px-4 pb-4 sm:px-6 sm:pb-6 lg:px-[120px] py-6">
				<div className="mx-auto flex w-full max-w-9xl flex-1 flex-col gap-4 lg:flex-row lg:gap-6 ">
					{/* Left Panel - API Parameters - 40% on desktop */}
					<aside className="flex w-full shrink-0 flex-col rounded-xl border border-gray-200 bg-white shadow-lg lg:w-[40%] transition-transform ">
						{/* Scrollable Content */}
					...
					{/* Right Panel - Map View + Search Results - 60% on desktop */}
					<div className="flex min-h-[500px] flex-1 flex-col rounded-xl border border-gray-200 bg-white shadow-sm lg:min-h-0 lg:w-[60%] ">
						{/* Map Header */}

						{/* Map Area */}
						<div className="relative min-h-[350px] flex-1 sm:min-h-[400px] lg:min-h-128">
							<MapView
								markers={markers}
						...
						{apiType === 'autocomplete' && (
							<div className="h-[280px] shrink-0  border-t border-gray-200">
						...
						<div className="shrink-0 border-t border-gray-200 bg-white">
							...
							<div className="h-[150px] overflow-auto rounded-b-xl bg-slate-800 p-3 sm:h-[180px] sm:p-4 lg:h-[200px]">
