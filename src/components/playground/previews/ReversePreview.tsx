...
export function ReversePreview() {
	return (
		<div className="relative h-full w-full">
			...
			<div className="absolute inset-0 bg-gradient-to-br from-orange-50 to-amber-100 opacity-50" />
			<svg
			...
			<div className="absolute top-1/3 left-1/2 -translate-x-1/2 transform">
				<div className="mb-1 min-w-[120px] rounded-lg border border-orange-200 bg-white p-2 shadow-lg">
			...
			<div className="absolute right-4 bottom-4 rounded bg-white/80 px-2 py-1">
				<span className="font-mono text-[8px] text-orange-600">21.0285, 105.8542</span>
			</div>
		</div>
	);
}
